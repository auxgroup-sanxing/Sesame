...
public class DehydrateManager
{
    ...
    public static void dehydrate( String uuid, String actionId, ExecutionContext ec )
    {
        actionIds.put( uuid, actionId );
        cache.put( ec.getUuid(), ec );
        instackTimestamps.put( ec.getUuid(), Long.valueOf( System.currentTimeMillis() ) );
    }
    ...
    public static ExecutionContext hydrate( String uuid )
    {
        ...
        ExecutionContext ec = cache.get( uuid );
    ...
    public static List<ExecutionContext> getTimeoutExecutionContexts()
    {
        ...
        while ( iter.hasNext() )
        {
            ...
            long timestamp = instackTimestamps.get( key ).longValue();
