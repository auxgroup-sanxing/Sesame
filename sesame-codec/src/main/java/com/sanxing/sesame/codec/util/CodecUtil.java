...
public class CodecUtil
{
    ...
    private static boolean complexElementHasFormat( XmlSchemaElement element, XmlSchema schema )
        throws FormatException
    {
        boolean result = false;
        ...
        if ( it.hasNext() )
        {
            ...
            XmlSchemaType elementType =
                ( childElement.getRefName() != null ) ? schema.getElementByName( childElement.getRefName() ).getSchemaType()
                    : childElement.getSchemaType();
