...
public class RidFillBlank {
	public static String ridRightBlank(byte[] buf, int blank, String type,
	...
	public static String ridLeftBlank(byte[] buf, int blank, String type,
			String charset) throws FormatException {
		String result = null;
	...
	public static String fillBlank(String elementValue, int length, char blank,
			String align, String encodeCharset, String elementName)
		...
		if (len > length) {
			throw new FormatException("element:[" + elementName
					+ "],length of elementValue:[" + elementValue
