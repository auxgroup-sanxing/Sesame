    ...
    extends WrapperListenerSupport
{
        ...
        throws Exception
    {
        ...
        {
            log.info( "JVM ID: {}, JVM PID: {}, Wrapper PID: {}, User: {}", WrapperManager.getJVMId(),
                WrapperManager.getJavaPID(), WrapperManager.getWrapperPID(), WrapperManager.getUser( false ).getUser() );
        }
