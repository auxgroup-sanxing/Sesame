...
public class TemplateManager
{
    ...
    public static CustomizedQueryTemplate getCustomizedQueryTemplate( String dsName )
    {
        return TemplateHelper.getDataAccessTemplate( dsName );
    }

    public static CustomizedUpdateTemplate getCustomizedUpdateTemplate( String dsName )
    {
        return TemplateHelper.getDataAccessTemplate( dsName );
    }
}