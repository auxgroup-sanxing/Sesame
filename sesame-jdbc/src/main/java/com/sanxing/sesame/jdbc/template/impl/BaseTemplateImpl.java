...
public class BaseTemplateImpl
{
    ...
    protected List exeQuery( String sql, ParametersMapping paramMapping, IndexedRowMapping indexedRowMapping )
    {
        logSql( sql );
        ...
        ResultSet rs = null;
        DataSource ds = TemplateHelper.getDataSource( dsName );
        try
        {
