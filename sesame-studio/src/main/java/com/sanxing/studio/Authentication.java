    ...
    implements Filter
{
                ...
                else
                {
                    ...
                    if ( auth != null )
                    {
                        ...
                        try
                        {
                            ...
                            loginCtx = new LoginContext( "Studio", null, handler, new LoginConfiguration() );
                            loginCtx.login();
                        ...
                        catch ( LoginException e )
                        {
                            ...
                            res.setHeader( "WWW-Authenticate",
                                "Digest realm=\"Sesame Studio\",qop=\"auth,auth-int\",nonce=\"" + nonce + "\"" );
                            res.sendError( 401 );
                        }
                    }
                    else
    ...
    static
    {
        LOG.debug( "login.configuration.provider=" + LoginConfiguration.class.getName() );
    }
}