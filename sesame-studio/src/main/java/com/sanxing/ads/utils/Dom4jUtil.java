...
public class Dom4jUtil {
	...
	public static void initDocument(String path) throws DocumentException {
		...
		map.put("sn", "http://www.sanxing.com/ns/statenet");
		saxReader.getDocumentFactory().setXPathNamespaceURIs(map);
		saxReader.setEncoding("UTF-8");
		document = saxReader.read(xmlFile);
	}

	public static void initDocument(File file) throws DocumentException {
		SAXReader saxReader = new SAXReader();
		saxReader.setEncoding("UTF-8");
	...
	public static org.dom4j.Element getElement(org.dom4j.Element parent,
			String elName) {
	...
	public static org.w3c.dom.Element parseDOM4JElement2DOMElement(
			org.dom4j.Element dom4jElement) throws Exception {
		org.w3c.dom.Element w3cElement = parseDOM4JDocument2Document(
				dom4jElement.getDocument()).getDocumentElement();
		return w3cElement;
	}

	public static org.dom4j.Element parseDOMElement2DOM4JElement(
			org.w3c.dom.Element w3cElement) throws Exception {
		org.dom4j.Element dom4jElement = parseDOM2DOM4JDocument(
				w3cElement.getOwnerDocument()).getRootElement();
		return dom4jElement;
	}

	public static org.dom4j.Document parseDOM2DOM4JDocument(
	...
	public static org.w3c.dom.Document parseDOM4JDocument2Document(
			org.dom4j.Document doc) throws Exception {
		if (doc == null) {
			return null;
		}
	...
	public static void setAttributeValue(org.dom4j.Element el, String attrName,
			String attrValue) {
	...
	public static String getDocumentation() {
		...
		value = (root.element("documentation") != null) ? root.element(
	...
	public static void addNamespace(org.dom4j.Element el, String prefix,
			String uri) {
	...
	public static void saveFile(String xmlPath) throws IOException {
	...
	public static void saveFile(File xmlPath) throws IOException {
		OutputFormat form = OutputFormat.createPrettyPrint();
		form.setEncoding("UTF-8");
	...
	public static class JBI {
		...
		public static org.dom4j.Element getServices() {
			org.dom4j.Element consumes = (org.dom4j.Element) Dom4jUtil.document
					.selectSingleNode("//*[name()='services']");

			return consumes;
		}

		public static List getArtLinkList() {
			List operList = Dom4jUtil.document
					.selectNodes("//*[name()='services']/*[local-name()='link']");
	...
	public static class PortType {
		public static String getName() {
			org.dom4j.Element ptEl = (org.dom4j.Element) Dom4jUtil.document
					.selectSingleNode("//*[name()='portType']");
		...
		public static List getOperList() {
			List operList = Dom4jUtil.document
					.selectNodes("//*[name()='portType']/*[name()='operation']");

			return operList;
		}

		public static org.dom4j.Element addOperation(String intfName) {
			org.dom4j.Element root = (org.dom4j.Element) Dom4jUtil.document
					.selectSingleNode("//*[name()='portType']");
		...
		public static List getPortTypeList() {
			List portTypeList = Dom4jUtil.document
					.selectNodes("//*[name()='portType']");
		...
		public static org.dom4j.Element addOperation(
				org.dom4j.Element portType, String intfName) {
		...
		public static org.dom4j.Element createPutElement(
				org.dom4j.Element operation, String elName, String msgValue) {
		...
		public static String getElementValue(org.dom4j.Element operation,
				String elName) {
			String value = "";
	...
	public static class Service {
		public static org.dom4j.Element getService() {
			org.dom4j.Element serviceEl = (org.dom4j.Element) Dom4jUtil.document
					.selectSingleNode("//*[name()='service']");
		...
		public static List getPortList() {
			...
			ports = Dom4jUtil.document
					.selectNodes("//*[name()='service']/*[name()='port']");

			return ports;
		}

		public static String getPortAttrValue(org.dom4j.Element port,
				String attrName) {
			String atrValue = "";
	...
	public static class Binding {
		public static org.dom4j.Element getRoot() {
			org.dom4j.Element bindingEl = (org.dom4j.Element) Dom4jUtil.document
					.selectSingleNode("//*[name()='binding']");
		...
		public static String getName() {
			...
			String name = (bindingEl == null) ? "" : Dom4jUtil
					.getAttributeValue(bindingEl, "name");
			return name;
		}
		...
		public static String getType() {
			...
			String type = (bindingEl == null) ? "" : Dom4jUtil
					.getAttributeValue(bindingEl, "type");
			return type;
		}

		public static List getOperList() {
			List operList = Dom4jUtil.document
					.selectNodes("//*[name()='binding']/*[name()='operation']");

			return operList;
		}

		public static String getComponentName() {
			org.dom4j.Element bindingChildEl = (org.dom4j.Element) Dom4jUtil.document
					.selectSingleNode("//*[name()='binding']/*[local-name()='binding']");

			String componentName = (bindingChildEl == null) ? "" : Dom4jUtil
					.getAttributeValue(bindingChildEl, "component-name");
		...
		public static String getTransport() {
			...
			String transport = (bindingChildEl == null) ? "" : Dom4jUtil
					.getAttributeValue(bindingChildEl, "transport");
			return transport;
		}
		...
		public static String getActionType() {
			...
			String type = (bindingChildEl == null) ? "" : Dom4jUtil
					.getAttributeValue(bindingChildEl, "type");
			return type;
		}
		...
		public static String getXpath() {
			...
			String type = (bindingChildEl == null) ? "" : bindingChildEl
		...
		public static List getBindingList() {
			List bindingList = Dom4jUtil.document
					.selectNodes("//*[name()='binding']");

			return bindingList;
		}

		public static String getName(org.dom4j.Element bindingEl) {
			String name = (bindingEl != null) ? Dom4jUtil.getAttributeValue(
					bindingEl, "name") : "";
			return name;
		}

		public static String getType(org.dom4j.Element bindingEl) {
			String type = (bindingEl != null) ? Dom4jUtil.getAttributeValue(
					bindingEl, "type") : "";
			return type;
		}
		...
		public static org.dom4j.Element getElement(org.dom4j.Element operation,
				String elName) {
			org.dom4j.Element el = null;
			List list = operation.elements();
			Iterator itr = list.iterator();
		...
		public static String getComponentName(org.dom4j.Element bindingEl) {
			org.dom4j.Element bindingChildEl = (org.dom4j.Element) bindingEl
					.selectSingleNode("//*[local-name()='binding']");
		...
		public static String getTransport(org.dom4j.Element bindingEl) {
			...
			if (bindingChildEl == null)
				return "";
			String transport = Dom4jUtil.getAttributeValue(bindingChildEl,
					"transport");
			return transport;
		}
	...
	public static class Message {
		public static void initMessage() {
			List msgList = Dom4jUtil.document
					.selectNodes("//*[name()='message']");
		...
		public static void modifyMessage(String oldName, String operName) {
			...
			for (int i = 0; i < msgList.size(); ++i) {
				...
				String name = Dom4jUtil.getAttributeValue(msg, "name")
						.replaceAll("(R|r)(equest|esponse)", "");
				if (name.equals(oldName)) {
					msg.addAttribute("name", name.replaceAll(oldName, operName));

					org.dom4j.Element port = Dom4jUtil.getElement(msg, "port");
					String type = (port == null) ? "" : Dom4jUtil
							.getAttributeValue(port, "type");
					String portname = (port == null) ? "" : Dom4jUtil
							.getAttributeValue(port, "name");
					port.addAttribute("type",
							type.replaceAll(oldName, operName));
					port.addAttribute("name",
							portname.replaceAll(oldName, operName));
				}
			}
		}
		...
		public static org.dom4j.Element createMessage(String operName,
				boolean isRequest) {
			org.dom4j.Element msgEl = Dom4jUtil.getRootEl().addElement(
					"message");
	...
	public static class Types {
		public static org.dom4j.Element getSchema() {
			org.dom4j.Element schemaEl = (org.dom4j.Element) Dom4jUtil.document
					.selectSingleNode("//*[name()='types']/*[local-name()='schema']");

			if (schemaEl == null) {
				org.dom4j.Element typesEl = (org.dom4j.Element) Dom4jUtil.document
						.selectSingleNode("//*[name()='types']");

				if (typesEl == null) {
					typesEl = Dom4jUtil.getRootEl().addElement("types");
				}
				schemaEl = typesEl.addElement(new QName("schema", Namespace
						.get("xs", "http://www.w3.org/2001/XMLSchema")));
			}
			return schemaEl;
		}

		public static List getIncludeList() {
			List includeList = Dom4jUtil.document
					.selectNodes("//*[name()='types']/*[local-name()='schema']/*[local-name()='include']");
