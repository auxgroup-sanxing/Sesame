...
.upload-icon {
	background: url('../images/tool16/image_add.png') no-repeat 0 0
		!important;
}

.upload-package {
	background: url('../images/tool16/package_add.png') no-repeat 0 0
		!important;
}
			...
			<div id="samples" unselectable="on" class="x-unselectable">
				...
				<div id="sample-menu">
					<div id="sample-menu-inner" style="color: white;">
						<big><b>提示信息</b></big><br />
						<br /> <u>组件</u>包含两大类：绑定组件和引擎组件，绑定组件负责平台与外部通讯和编码解码，引擎组件执行特定的业务逻辑。<br />
						<u>共享库</u>包含多个组件共享的功能代码。<br /> <u>传输端子</u>负责与外部通讯，可自由扩展。传输端子也是打包成共享库安装，可以在多个组件间共享使用。
					</div>
				</div>
				<div id="sample-box">
