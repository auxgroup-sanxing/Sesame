...
var associations = {
	'' : { type: 'text', syntax: 'text'},
	'bat' : { type: 'text', syntax: 'text'},
	'css' : { type: 'text', syntax: 'css'},
	'conf' : { type: 'text', syntax: 'text'},
	'config' : { type: 'text', syntax: 'text'},
	'doc' : { type: 'application'},
	'htm' : { type: 'text', syntax: 'html'},
	'html' : { type: 'text', syntax: 'html'},
	'jar' : { type: 'application'},
	'java' : { type: 'text', syntax: 'java'},
	'js' : { type: 'text', syntax: 'javascript'},
	'json' : { type: 'text', syntax: 'text'},
	'jsp' : { type: 'text', syntax: 'html'},
	'log' : { type: 'text', syntax: 'text'},
	'properties' : { type: 'text', syntax: 'text'},
	'sh' : { type: 'text', syntax: 'text'},
	'sql' : { type: 'text', syntax: 'sql'},
	'txt' : { type: 'text', syntax: 'text'},
	'vm' : { type: 'text', syntax: 'html'},
	'xhtml' : { type: 'text', syntax: 'html'},
