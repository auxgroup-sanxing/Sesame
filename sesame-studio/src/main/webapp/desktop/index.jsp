...
<div id="x-desktop"  style="cursor: default;">
    ...
    <dl unselectable="on"  id="x-shortcuts">
        ...
        <dt unselectable="on"  id="logger-win-shortcut"  style="float:right;padding:0 20px;clear:right;">
 			<a href="#"><img src="images/guake.png"/><br/>
 				<span>系统日志</span>
 			</a>
 		</dt>	
        
 		<dt unselectable="on"  id="project-explorer-shortcut"  class="noneFloat" >
 			<a href="#">
 				<img src="images/project_explorer.png"/><br/>
 				<span>项目浏览器</span>
 			</a>
 		</dt>
 		...
 		<dt unselectable="on"  id="ware-explorer-shortcut" class="noneFloat" >
 			<a href="#">
 				<img src="images/warehouse_explorer.png"/><br/>
 				<span>公共资源库</span>
 			</a>
 		</dt>
 		...
 		<dt unselectable="on"  id="prefs-win-shortcut" class="noneFloat" >
 			<a href="#">
 				<img src="images/control_panel.png"/><br/>
 				<span>控制面板</span>
 			</a>
 		</dt>
...
<div id="inactive-container" style="display: none;">
	<div id="statusDiv"  unselectable="off" style="-moz-user-select: -moz-all;" onselectstart="javascript:return true;"></div>
</div>
</body>
</html>
