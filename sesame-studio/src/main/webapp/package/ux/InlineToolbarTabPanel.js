...
Ext.ux.InlineToolbarTabPanel = Ext.extend(Ext.TabPanel, {
  ...
  ,onResize: function() {
    ...
    this.header.setWidth((Ext.isIE || Ext.isGecko3 || Ext.isGecko4)?w-4:w);    //(Ext.isIE6)?(w-2);
    ...
    this.tbHeader.alignTo(this.header, 'tr', (Ext.isGecko && !Ext.isGecko3 && !Ext.isGecko4)?[-1,-1]:[0,0]);
  ...
  ,setToolbar: function(obj) {
    ...
    this.tbWrap = this.tbHeader.createChild({
      id:'tbWrap'
      ,style:'border-left:0px none;border-right:1px solid #8DB2E3 !important;'
      ,cls:cls
    });

    this.tbContainer = this.tbWrap.createChild({
      id:'tbContainer',
      style: 'border-left:0px solid #8DB2E3;border-top:0px none;'
