...
<body>
	...
	<form name="form" enctype="application/x-www-form-urlencoded"
		method="post">
		<input type="hidden" name="password" />
		<table style="width: 100%">
			<tr>
				<td align="left">键入新帐户标识<br />
				<input type="text" name="userid" style="width: 240px;" /><br /></td>
			</tr>
			<tr>
				<td align="left">键入新帐户名称<br />
				<input type="text" name="fullname" style="width: 240px;" /><br /></td>
			</tr>
			<tr>
				<td align="left">键入新帐户密码<br />
				<input type="password" name="password1" style="width: 240px;" /><br /></td>
			</tr>
			<tr>
				<td align="left">再次输入帐户密码<br />
				<input type="password" name="password2" style="width: 240px;" /><br /></td>
			</tr>
			<tr>
				<td align="right"><input type="button" onclick="submitCheck()"
					value="下一步"><input type="button" value="取消"
