		...
		<tr>
			...
			%>
					<tr>
						...
						<td><a onclick='href="ChangePwd.jsp?userid=<%=userId%>"'
							href="goto:" target="_self">更改我的密码</a></td>
					</tr>
					<tr>
						<td><img src="../images/icons/right_a.gif"></td>
						<td><a onclick='href="ChangeLogo.jsp?userid=<%=userId%>"'
							href="goto:" target="_self">更改我的图片</a></td>
					</tr>
					<%
			}
			else
			...
			%>
					<tr>
						<td><img src="../images/icons/right_a.gif"></td>
						<td><a
							onclick='href="ChangeName.jsp?userid=<%=userId%>&fullname=<%=user.getString("fullname")%>"'
							href="#" target="_self">更改名称</a></td>
					</tr>
					<tr>
						<td><img src="../images/icons/right_a.gif"></td>
						<td><a onclick='href="ChangePwd.jsp?userid=<%=userId%>"'
							href="goto:" target="_self">更改密码</a></td>
					</tr>
					<tr>
						<td><img src="../images/icons/right_a.gif"></td>
						<td><a onclick='href="ChangeLogo.jsp?userid=<%=userId%>"'
							href="goto:" target="_self">更改图片</a></td>
					</tr>
					<tr>
						<td><img src="../images/icons/right_a.gif"></td>
						<td><a
							onclick='href="ChangeKind.jsp?userid=<%=userId%>&kind=<%=user.getString("userlevel")%>"'
							href="#" target="_self">更改账户类型</a></td>
					</tr>
					<%
				...
				%>
					<tr>
						<td><img src="../images/icons/right_a.gif"></td>
						<td><a
							onclick='this.href="ChangeRole.jsp?userid=<%=userId%>"'
							href="goto:" target="_self">更改角色</a></td>
					</tr>
					<%
				}
				%>
					<tr>
						<td><img src="../images/icons/right_a.gif"></td>
						<td><a
							onclick='this.href="RemoveUser.jsp?userid=<%=userId%>"'
							href="goto:" target="_self">删除帐户</a></td>
					</tr>
					<%
			}
			%>
