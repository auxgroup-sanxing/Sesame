...
<body>
	...
	<form name="form" action="../UserAction" method="post">
		<input type="hidden" name="userid" value="<%=userId%>"> <input
			type="hidden" name="fullname" value="<%=fullName%>"> <input
		...
		<table style="width: 100%">
					...
					<table>
						<tr>
							<td><input type="radio" name="kind" id="radio1" value="S"
								checked="checked"
								onclick="document.getElementById('Description').innerHTML=sAdminDscr"><label
								for="radio1">系统管理员</label></td>
							<td><input type="radio" name="kind" id="radio2" value="C"
								onclick="document.getElementById('Description').innerHTML=sRestrictDscr"><label
			...
			<tr>
				<td align="right"><input type="button"
					onclick="window.history.back(-1)" value="上一步"> <input
					type="submit" value="创建帐户"> <input type="button" value="取消"
					onclick="window.open('UserHome.jsp', '_self')"></td>
			</tr>
		</table>
	</form>
	<script type="text/javascript">
