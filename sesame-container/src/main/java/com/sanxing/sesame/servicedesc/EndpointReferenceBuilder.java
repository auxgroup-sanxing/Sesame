...
public final class EndpointReferenceBuilder
{
    ...
    public static DocumentFragment getReference( ServiceEndpoint endpoint )
    {
        try
        {
            ...
            Element epr =
                doc.createElementNS( "http://java.sun.com/jbi/end-point-reference", "jbi:end-point-reference" );
            epr.setAttributeNS( "http://www.w3.org/2000/xmlns/", "xmlns:sns",
                endpoint.getServiceName().getNamespaceURI() );
            epr.setAttributeNS( "http://java.sun.com/jbi/end-point-reference", "jbi:service-name", "sns:"
                + endpoint.getServiceName().getLocalPart() );
            epr.setAttributeNS( "http://java.sun.com/jbi/end-point-reference", "jbi:end-point-name",
