...
{
  private static final int[] FIELDS_SIZE = { 4, 2, 1, 4, 2, 2, 2, 12, 8, 8, 
    16, 1, 2 };

  private static final String[] FIELDS_DESC = { "交易代码", "交易子码", "交易模式", 
    "交易序号", "本交易包长度", "系统偏移1", "系统偏移2", "前台流水号", "前台日期", "授权柜员", 
    "授权密码", "授权柜员有无卡标志", "授权柜员卡序号" };
