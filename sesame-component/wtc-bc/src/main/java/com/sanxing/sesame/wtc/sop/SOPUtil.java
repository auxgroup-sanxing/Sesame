...
public class SOPUtil
{
    ...
    public static byte[] getMAC( byte[] sopBuf )
    {
        ...
        System.arraycopy( sopBuf, 2, mac, 0, 16 );
        return mac;
    }
    ...
    public static byte[] gettranCode( byte[] sopBuf )
    {
        ...
        System.arraycopy( sopBuf, 21, tranCodeBytes, 0, 4 );
    ...
    {
        length = length < bytes.length - start ? length : bytes.length - start;
        byte[] result = new byte[length];
    ...
    {
        byte[] bytes = { 77, 65, 67, 32, -48, -93, -47, -23, -54, -89, -80, -36 };
        try
        {
