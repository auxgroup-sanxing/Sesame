...
public class VariableElement
{
    ...
    throws FormatException
  {
    try
    {
      ...
      if ("string".equals(this.elementType)) {
        ...
        throw new FormatException("element:[" + this.elementName + 
          "],type:[" + this.elementType + "],value length is:[" + 
          this.elementValue.getBytes(this.encodeCharset).length + 
  ...
  public String subString(int start) throws FormatException {
    try {
      int total = getByteNumber();
