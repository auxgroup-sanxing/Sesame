...
public class SOPSysHead
{
  ...
  private static final int[] FIELDS_SIZE = { 2, 16, 4, 16, 3, 3, 1, 1, 1, 9, 
    1, 2, 1, 4, 3, 20, 20 };

  private static final String[] FIELDS_DESC = { "数据包长度", "报文MAC", "MAC机构号", 
    "PIN种子", "渠道来源", "渠道去向", "加密标志", "PIN标志", "组合标志", "主机服务名", 
    "信息结束标志", "报文序号", "校验标志", "密钥版本号", "系统标识符", "密码偏移量", "帐号偏移量" };
  private short size;
  private String mac;
  ...
  public String toString()
  {
    ...
    sb.append(SOPUtil.format(FIELDS_DESC[(index++)], new String(
      this.passwdOffset)));
