    ...
    extends DecodeFSV
{
        ...
        throws FormatException
    {
        ...
        if ( schema == null )
        {
            ...
            throw new FormatException( "In WTCDecoder,can not find schema in BinarySource!" );
        }
        ...
        try
        {
            ...
            if ( length <= 0 )
            {
                throw new FormatException( "In WTCDecoder, not enough bytes can be read." );
            }
    ...
    public Element decodeHead( byte[] message, int length, String charset )
        throws FormatException
    {
        try
        {
            ...
            System.arraycopy( message, 38, fromBytes, 0, 3 );
            System.arraycopy( message, 41, toBytes, 0, 3 );
            System.arraycopy( message, 45, pinflagBytes, 0, 1 );
            System.arraycopy( message, 22, pinseedBytes, 0, 16 );
    ...
    public void decodeVField( ByteBuffer message, String charset, Element elementMessage, String elementName,
                              Element childOfElementMessage, String type, ValidateVFormat vVFormat )
        throws FormatException
    {
        ...
        String value = decodeVField( message, charset, elementName, type, headLength, headBlank, headAlign, headRadix );

        childOfElementMessage.addContent( value );
        elementMessage.addContent( childOfElementMessage );
    }

    private String decodeVField( ByteBuffer message, String charset, String elementName, String type, int headLength,
                                 int headBlank, String headAlign, int headRadix )
        throws FormatException
    {
        ...
        if ( lengthString != null )
        {
            ...
            {
                value = getField( message, charset, 250, type );
                length -= 250;
                value =
                    value.concat( decodeVField( message, charset, elementName, type, headLength, headBlank, headAlign,
                        headRadix ) );
            }
        }
    ...
    private String getField( ByteBuffer message, String charset, int length, String type )
        throws FormatException
    {
