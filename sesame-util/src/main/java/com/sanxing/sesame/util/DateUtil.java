...
public class DateUtil {
	...
	public static java.sql.Date getAfterNDay(java.util.Date date, int n)
		...
		String nDayString = new SimpleDateFormat("yyyy/MM/dd")
				.format(new java.util.Date(nDay));
	...
	public static void main(String[] args) {
		System.out.println(getFullText(new java.util.Date()));

		System.out.println(getDateStrWithDASH(new java.util.Date()));

		System.out.println(getDateStrWithSPLASH(new java.util.Date()));
