...
public class BeanUtil
{
    ...
    public static BeanMetaData getBeanMetaData( Class<?> baseClazz )
    {
        if ( baseClazz == null )
        {
            throw new NullPointerException( "get property type:base clazz is null" );
        }
        synchronized ( baseClazz )
        {
            BeanMetaData tempBeanMetaData = beanCache.getBeanMetaData( baseClazz );
    ...
    public static void setProperty( Object base, String propName, Object propValue )
    {
        Class baseClazz = base.getClass();
        if ( baseClazz == null )
        {
