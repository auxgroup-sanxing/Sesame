...
public class LuceneLogBeanRecord
    extends LuceneRecord
{
    private static final Logger LOG = LoggerFactory.getLogger( LuceneLogBeanRecord.class );

    private static final String[] fields = { "serialNumber", "state", "serviceName", "operationName",
        "transactionCode", "channel", "content" };
