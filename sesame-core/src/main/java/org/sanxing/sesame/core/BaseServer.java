...
import org.sanxing.sesame.executors.Callback;
import org.sanxing.sesame.executors.ExecutorFactory;
import org.sanxing.sesame.executors.impl.ExecutorFactoryImpl;
import org.sanxing.sesame.jmx.mbean.ServerManager;
import org.sanxing.sesame.jmx.mbean.admin.ClusterEvent;
import org.sanxing.sesame.jmx.mbean.admin.ContainerInfo;
import org.sanxing.sesame.jmx.mbean.admin.ServerInfo;
import org.sanxing.sesame.jmx.mbean.managed.FileClient;
import org.sanxing.sesame.platform.api.Container;
import org.sanxing.sesame.platform.api.ContainerContext;
import org.sanxing.sesame.platform.api.MBeanHelper;
import org.sanxing.sesame.platform.jdbc.DataSourceInfo;
import org.sanxing.sesame.platform.jdbc.DataSourceProvider;
import org.sanxing.sesame.platform.jms.JMSProvider;
import org.sanxing.sesame.platform.listener.ClusterListener;
import org.sanxing.sesame.util.SystemProperties;
import java.io.File;
...
public class BaseServer {
	...
	protected JMSProvider getJmsProvider() {
		if (this.jmsProvider == null) {
			String providerClazz = SystemProperties.get(
					"org.sanxing.sesame.platform.jms.provider",
					"org.sanxing.sesame.platform.jms.ActiveMQJMSProvider");
			try {
	...
	protected DataSourceProvider getDataSourceProvider(
		...
		if (transactionManagerType == 1)
			providerClazz = "org.sanxing.sesame.platform.jdbc.STMProvider";
		else if (transactionManagerType == 2)
			providerClazz = "org.sanxing.sesame.platform.jdbc.BTMProvider";
		else
			providerClazz = SystemProperties.get(
					"org.sanxing.sesame.platform.jdbc.datasource.provider",
					"org.sanxing.sesame.platform.jdbc.DBCPProvider");
		try {
	...
	protected void startContainers() {
		...
		jbi.setContainerClazz("org.sanxing.sesame.runtime.RuntimeContainer");
		jbi.setName("jbi");
		regsiterContainer(jbi);

		ContainerInfo webapps = new ContainerInfo();
		webapps.setContainerClazz("org.sanxing.sesame.runtime.WebAppContainer");
