...
/**
 * Sesame system state object. It gives small amount of important infos about Sesame Application.
 *
 * @author ShangjieZhou
 */
public class SystemStatus
{
     ...
     */
    private String appName = "Sanxing Sesame";

    /**
     * The Formatted Application Name, used whenever possible
     */
    private String formattedAppName = "Sanxing Sesame&trade;";

    /**
     * The Sesame Application version.
     */
    private String version = "unknown";

    /**
     * The Sesame Java API version (not the REST API!).
     */
    private String apiVersion = "unknown";

    /**
     * The Sesame Application edition for display in UI.
     */
    private String editionLong = "";

    /**
     * The Sesame Application edition for user agent
     */
    private String editionShort = "OSS";

    /**
     * The Sesame attributions url
     */
    private String attributionsURL = "http://links.sanxing.com/products/sesame/oss/attributions";

    /**
     * The Sesame attributions url
     */
    private String purchaseURL = "http://links.sanxing.com/products/sesame/oss/store";

    /**
     * The Sesame attributions url
     */
    private String userLicenseURL = "http://links.sanxing.com/products/sesame/oss/EULA";

    /**
     * The Sesame Application state.
     */
    private SystemState state;

    /**
     * The Sesame operation mode.
     */
    private OperationMode operationMode;

    /**
     * The time this instance of Sesame was started.
     */
    ...
    public boolean isSesameStarted()
    {
