    ...
    extends MultiParentClassLoader
{
    ...
    public JarFileClassLoader( URL[] urls, ClassLoader parent, boolean inverseClassLoading, String[] hiddenClasses,
    ...
    public JarFileClassLoader( URL[] urls, ClassLoader[] parents, boolean inverseClassLoading,
    ...
    public JarFileClassLoader( URL[] urls, ClassLoader[] parents, boolean inverseClassLoading, String[] hiddenClasses,
                               String[] nonOverridableClasses )
    {
        super( EMPTY_URLS, ClassLoader.getSystemClassLoader(), parents, inverseClassLoading, hiddenClasses,
            nonOverridableClasses );
        ...
        try
        {
            return ( (Class) AccessController.doPrivileged( new PrivilegedExceptionAction()
            {
                    ...
                    throws ClassNotFoundException
                {
                    ...
                    JarFileClassLoader.this.definePackage( className, codeSourceUrl, manifest );

                    CodeSource codeSource = new CodeSource( codeSourceUrl, certificates );

                    return JarFileClassLoader.this.defineClass( className, bytes, 0, bytes.length, codeSource );
                }
            }, acc ) );
        }
