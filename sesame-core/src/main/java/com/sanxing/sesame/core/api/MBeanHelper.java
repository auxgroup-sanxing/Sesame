...
public class MBeanHelper
{
    ...
    private static JMXConnector getConnector( String serverName )
    {
        ...
        if ( connectors.containsKey( serverName ) )
        {
            try
            {
                jmxServerConnector = connectors.get( serverName );
                jmxServerConnector.getMBeanServerConnection().getDefaultDomain();
            }
            catch ( Exception e )
            {
                valid = false;
        ...
        if ( ( !( connectors.containsKey( serverName ) ) ) || ( !( valid ) ) )
        {
            ...
            {
                jmxServerURL = Platform.getJmxServiceURLBuilder().getAdminJMXServiceURL();
            }
            else
            {
                if ( serverName.endsWith( Platform.getEnv().getServerName() ) )
                {
                    jmxServerURL = Platform.getJmxServiceURLBuilder().getLocalJMXServiceURL();
                }
                else
                {
                    jmxServerURL = Platform.getJmxServiceURLBuilder().getJMXServiceURLByServerName( serverName );
                }
            }
            try
            {
                ...
                jmxServerConnector = JMXConnectorFactory.connect( jmxServerURL, environment );
        ...
        return connectors.get( serverName );
    }
    ...
    public static <T> T getAdminMBean( Class<T> clazz, String name )
    {
        ...
        {
            ObjectName oname =
                ObjectName.getInstance( Platform.getEnv().getDomain() + ":ServerName=admin,Type=Platform" + ",Name="
                    + name );
    ...
    public static <T> T getManagedMBean( Class<T> clazz, ObjectName name )
    {
        try
        {
            JMXConnector jmxServerConnector = getConnector( Platform.getEnv().getServerName() );

            MBeanServerConnection adminServerCon = jmxServerConnector.getMBeanServerConnection();
    ...
    public static ObjectName getMBeanName( String beanName )
    {
        try
        {
            return ObjectName.getInstance( Platform.getEnv().getDomain() + ":ServerName="
                + Platform.getEnv().getServerName() + ",name=" + beanName );
        }
    ...
    public static ObjectName getMBeanNameOnServer( String beanName, String serverName )
    {
        try
        {
            return ObjectName.getInstance( Platform.getEnv().getDomain() + ":ServerName=" + serverName
                + ",Type=Platform" + ",Name=" + beanName );
        }
        catch ( MalformedObjectNameException e )
        {
            throw new RuntimeException( "error got mbean name" );
    ...
    public static ObjectName getMBeanName( String type, String beanName )
    {
        ...
        {
            return ObjectName.getInstance( Platform.getEnv().getDomain() + ":ServerName="
                + Platform.getEnv().getServerName() + ",Type=" + type + ",Name=" + beanName );
        }
        catch ( MalformedObjectNameException e )
        {
            throw new RuntimeException( "error got mbean name" );
    ...
    public static ObjectName getMBeanName( String type, String subType, String beanName )
    {
        try
        {
            return ObjectName.getInstance( Platform.getEnv().getDomain() + ":ServerName="
                + Platform.getEnv().getServerName() + ",Type=" + type + ",SubType=" + subType + ",Name=" + beanName );
        }
        catch ( MalformedObjectNameException e )
        {
            throw new RuntimeException( "error got mbean name" );
    ...
    public static void registerMBean( MBeanServer server, Object mbean, ObjectName name )
    {
        try
        {
