...
public class SchemaCollection
{
    ...
    public static synchronized XmlSchema loadSchema( URL url )
        throws IOException
    {
    ...
    public static synchronized XmlSchema loadSchema( Element element, String systemId )
        throws IOException
    {
    ...
    public static synchronized void removeSchema( URL url )
        throws IOException
    {
    }
}