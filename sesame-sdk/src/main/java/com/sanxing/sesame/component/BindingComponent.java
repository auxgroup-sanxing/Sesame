...
{
    private final Map<ServiceEndpoint, ServiceUnit> endpoints = new ConcurrentHashMap();
        ...
        throws DeploymentException
    {
        try
        {
            ...
            {
                ServiceEndpoint endpoint = getContext().activateEndpoint( serviceUnit.getServiceName(), portName );
                endpoints.put( endpoint, serviceUnit );
            }
        }
        catch ( Exception e )
        {
        ...
        throws DeploymentException
    {
        try
        {
            ...
            for ( String portName : portNames )
            {
                ServiceEndpoint endpoint = getContext().getEndpoint( serviceUnit.getServiceName(), portName );
                if ( endpoint != null )
                {
        ...
        throws MessagingException
    {
        ...
        if ( ref != null )
        {
            ...
            if ( ( ref.getServcieName() != null ) && ( ref.getEndpointName() != null ) )
            {
                ServiceEndpoint endpoint = getContext().getEndpoint( ref.getServcieName(), ref.getEndpointName() );
        ...
        else
        {
            ...
            {
                throw new MessagingException( "Could not find route for operation: "
