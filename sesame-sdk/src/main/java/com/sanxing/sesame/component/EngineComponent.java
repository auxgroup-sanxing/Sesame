    ...
    implements MessageExchangeListener
{
        ...
        throws DeploymentException
    {
        try
        {
            ...
            ServiceEndpoint endpoint = getContext().activateEndpoint( serviceName, serviceUnitName );
        ...
        throws DeploymentException
    {
        try
        {
            ...
            ServiceEndpoint endpoint = getContext().getEndpoint( serviceName, serviceUnitName );
            if ( endpoint != null )
            {
