...
public class Protocols
{
    ...
    {
        URL url = Protocols.class.getClassLoader().getResource( "schemes/" + protocol + "-" + style + ".xsd" );
        return url;
    }
    ...
    {
        URL url =
            Protocols.class.getClassLoader().getResource( "schemes/" + protocol + "-" + style + "-context" + ".xsd" );
        return url;
    }
