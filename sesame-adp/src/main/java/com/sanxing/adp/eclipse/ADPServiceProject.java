...
public class ADPServiceProject {
	...
	public ADPServiceProject(String projectName, String serviceUnitPath)
		...
		File theFile = new File(serviceUnitPath
				+ "/../../../../warehouse/components/adp-ec/ADP_TEMPLATE.zip");
	...
	public void generateCode() throws Exception {
		String srcDir = this.serviceUnitPath + "/" + this.projectName + "/src/";
		String wsdlFile = this.serviceUnitPath + "/unit.wsdl";
