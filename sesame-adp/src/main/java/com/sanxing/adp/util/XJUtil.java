...
public class XJUtil {
	...
	public static final Namespace XSNS = Namespace
	...
	public static String ns2ClassName(QName ns) {
		return ns2package(ns.getNamespaceURI()) + "."
				+ StringUtils.capitalize(ns.getLocalPart());
	}
	...
	public static String xsType2Java(String xsType) {
		String javaType = (String) xs_java_map.get(xsType);
		if (javaType == null) {
	...
	public static Object xmlPrimitiv2Java(String javaType, String xsType,
		...
		if (javaType.equals("String"))
			...
			if (xsType.equals("date"))
				...
				try {
					...
					paramObj = new SimpleDateFormat("yyyy-MM-ddhh:mm:ss")
							.parse(strDate);
				} catch (ParseException e) {
					LOG.error("xmlPrimitiv2Java err ", e);
					throw e;
